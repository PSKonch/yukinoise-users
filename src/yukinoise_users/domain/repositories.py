...
class UserSettingsRepository(Protocol):
    """Repository protocol for user settings.

    Note: soft-delete and restore operations are intentionally *not* part of this
    repository's contract (user settings are not soft-deletable/restorable).
    """
